...
public class ProdutoController {
	...
	public ResponseEntity<Page<ProdutoDTO>> listProductsCategories(@RequestParam("nome-categoria")String nomeCategoria,Pageable pageable){
		return ResponseEntity.ok(service.listProductsCategory(nomeCategoria,pageable));
	}
	@GetMapping
